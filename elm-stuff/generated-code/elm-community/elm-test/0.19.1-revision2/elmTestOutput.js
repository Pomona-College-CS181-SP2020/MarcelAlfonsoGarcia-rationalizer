...
var $author$project$Model$Item = F3(
	function (ingredient, amount, measurement) {
		return {amount: amount, ingredient: ingredient, measurement: measurement};
	});
...
var $author$project$IngredientParser$ingredientParser = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$chompWhile(
		function (b) {
			return $elm$core$Char$isAlpha(b);
		}));
...
var $author$project$IngredientParser$measurementParser = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$chompWhile(
		function (b) {
			return $elm$core$Char$isAlpha(b);
		}));
var $author$project$IngredientParser$quantityParser = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$chompWhile(
		function (b) {
			return $elm$core$Char$isAlpha(b);
		}));
...
var $author$project$IngredientParser$itemParser = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				...
				$elm$parser$Parser$succeed($author$project$Model$Item),
				$elm$parser$Parser$spaces),
			$author$project$IngredientParser$ingredientParser),
		$author$project$IngredientParser$quantityParser),
	$author$project$IngredientParser$measurementParser);
...
var $author$project$IngredientParser$loopHelper = function (revItems) {
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$spaces),
				$author$project$IngredientParser$itemParser),
				A2(
				$elm$parser$Parser$map,
				function (_v0) {
...
var $author$project$IngredientParser$itemsParser = A2($elm$parser$Parser$loop, _List_Nil, $author$project$IngredientParser$loopHelper);
var $author$project$IngredientParser$recipeParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$ignorer,
			$elm$parser$Parser$succeed($author$project$Model$Recipe),
			$elm$parser$Parser$spaces),
		$author$project$IngredientParser$itemsParser),
...
var $author$project$IngredientParser$parse = function (recipe) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$IngredientParser$recipeParser, recipe);
	if (_v0.$ === 'Ok') {
		var x = _v0.a;
		return x;
	} else {
		return {items: _List_Nil, scale: 0.0};
	}
};
...
var $author$project$Example$emptyRecipe = A2(
...
var $author$project$Test$Generated$Main3111653550$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\Marcel Alfonso\\Desktop\\MarcelAlfonsoGarcia-rationalizer\\tests\\Example.elm']),
		processes: 4,
